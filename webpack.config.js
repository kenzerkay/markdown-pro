  ...
  plugins: [
    new CopyPlugin({
      patterns: [
        ...
        { from: "src/filesafe-encryption-worker.js", to: path.resolve(__dirname, "dist/filesafe-js/EncryptionWorker.js") },
        { from: "node_modules/standard-file-js/dist/sfjs.umd.js", to: path.resolve(__dirname, "dist/standard-file-js/sfjs.umd.js") },
